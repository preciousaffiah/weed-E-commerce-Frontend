...
export default function Card2({
  ...
  const addtocart = (_id, item_name, item_img, price) => {
    if (user_id) {
  ...
  return (
    <div className="row">
      <>
        {items?.map((item) => (
          <div className="col-6 col-md-3 col-sm-6 pb-4" key={item._id}>
            ...
            <div className="weed2_txt">
              ...
              <a className="text-decoration-none" href={`/product/${item._id}`}>
              ...
              <button
                onClick={() =>
                  addtocart(item._id, item.item_name, item.item_img, item.price)
                }
              >
                Add to Cart
              </button>
